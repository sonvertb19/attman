...
SECRET_KEY = '_s)d(j0!xh6rb&!jyedbw=lfk4-81$=9a**&ayulmxqt8v&cff'
...
STATIC_URL = '/static/'
LOGIN_URL = "/login/"
# AUTH_USER_MODEL = 'AttendanceManager.User'

CSRF_COOKIE_NAME = "csrftoken_attmanager"